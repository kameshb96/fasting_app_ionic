...
/* harmony import */ var _pipes_date_format_pipe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../pipes/date-format.pipe */ "./src/app/pipes/date-format.pipe.ts");
...
let HistoryPage = class HistoryPage {
    ...
    deleteHistory(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.resources.deleteCompletedFast(id).then(() => {
                this.shouldRefresh = true;
                this.refreshPage();
            });
        });
