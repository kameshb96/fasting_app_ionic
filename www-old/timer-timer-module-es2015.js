...
/* harmony import */ var _timer_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./timer.page */ "./src/app/timer/timer.page.ts");
...
/* harmony import */ var _timer_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./timer-routing.module */ "./src/app/timer/timer-routing.module.ts");
        ...
        this.resources.getTimerInfo().then((res) => {
            if (res) {
                ...
                if (chosenFast) {
                    ...
                    let cf = chosenFast;
                    this.resources.setChosenFast(new _shared_resources_service__WEBPACK_IMPORTED_MODULE_2__["Fast"](cf.title, cf.duration, cf.description, cf.IsPredefined));
...
TimerPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-timer',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./timer.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/timer/timer.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./timer.page.scss */ "./src/app/timer/timer.page.scss")).default]
    }),
