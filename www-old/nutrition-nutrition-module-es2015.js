...
/* harmony import */ var _nutrition_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./nutrition.page */ "./src/app/nutrition/nutrition.page.ts");
...
/* harmony import */ var _food_info_food_info_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../food-info/food-info.page */ "./src/app/food-info/food-info.page.ts");
/* harmony import */ var _shared_resources_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/resources.service */ "./src/app/shared/resources.service.ts");
...
let NutritionPage = class NutritionPage {
    ...
    ionViewWillEnter() {
        if (this.resources.IS_DEBUG_MODE)
            console.log(this.resources.currentNutritionPageDate);
    ...
    didChange() {
        this.slides.getActiveIndex().then(index => {
            ...
            if (index == 1)
                this.setPageData(this.currentPageDate);
            else if (index == 0)
    ...
    setTitle2(date) {
        ...
        if (diff == 0)
            ...
            t = cpd.toLocaleString('default', { weekday: 'long' })
                + ', '
    ...
    setTitle() {
        ...
        // Returns value of sample format: Thursday, Feb 20
            ...
            this.title = cpd.toLocaleString('default', { weekday: 'long' })
                + ', '
                + cpd.toLocaleString('default', { month: 'long' }).substr(0, 3)
                + ' '
                + cpd.getDate();
    ...
    getFilteredLogs(date) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.resources.getFoodLogs(this.resources.shouldRefreshLog).then((val) => {
    ...
    deleteLog(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.resources.shouldRefreshLog = true;
            yield this.resources.deleteLog(id).then(() => {
                this.refreshPage(this.currentPageDate, false);
            });
        });
    }
...
NutritionPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./nutrition.page.scss */ "./src/app/nutrition/nutrition.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"],
        _shared_resources_service__WEBPACK_IMPORTED_MODULE_4__["ResourcesService"],
