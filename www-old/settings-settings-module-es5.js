(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["settings-settings-module"], {
  ...
  function srcAppSettingsSettingsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _password_password_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    let SettingsPage = class SettingsPage {
      constructor(resources, modal, router, storage, notif) {
        ...
        this.notif = notif;
        console.log("Settings constructor"); // this.resources.getSettings().then((res: any) => {
        ...
        regeneratorRuntime.mark(function _callee2() {
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                console.log(this.resources.darkMode); // let st = ""
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_resources_service__WEBPACK_IMPORTED_MODULE_2__["ResourcesService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], _storage_service__WEBPACK_IMPORTED_MODULE_6__["StorageService"], _local_notifications_service__WEBPACK_IMPORTED_MODULE_7__["LocalNotificationsService"]])], SettingsPage);
    /***/
  }
}]);
