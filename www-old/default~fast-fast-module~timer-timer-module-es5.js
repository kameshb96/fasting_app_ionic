...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~fast-fast-module~timer-timer-module"], {
  /***/
    ...
    let CircleProgressComponent = class CircleProgressComponent {
      constructor(defaultOptions, elRef, document) {
        ...
        this.draw = percent => {
          ...
          if (circlePercent > 50) {
            var _ref = this.options.clockwise ? [1, 1] : [1, 0];
            ...
            var _ref3 = this.options.clockwise ? [0, 1] : [0, 0];
          ...
          let titleTextPercent = titlePercent > this.options.maxPercent ? "".concat(this.options.maxPercent.toFixed(this.options.toFixed), "+") : titlePercent.toFixed(this.options.toFixed);
          ...
          let units = {
            text: "".concat(this.options.units),
          ...
          this.svg = {
            ...
            path: {
              ...
              d: "M ".concat(startPoint.x, " ").concat(startPoint.y, "\n        A ").concat(this.options.radius, " ").concat(this.options.radius, " 0 ").concat(largeArcFlag, " ").concat(sweepFlag, " ").concat(endPoint.x, " ").concat(endPoint.y),
        ...
        this.animate = (previousPercent, currentPercent) => {
          ...
          let _this$getAnimationPar = this.getAnimationParameters(fromPercent, toPercent),
        ...
        this.applyOptions = () => {
          ...
          for (var _i2 = 0, _Object$keys = Object.keys(this.options); _i2 < _Object$keys.length; _i2++) {
            let name = _Object$keys[_i2];
  ...
  /***/
  function srcAppLocalNotificationsServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LocalNotificationsService", function () {
    ...
    let LocalNotificationsService = class LocalNotificationsService {
      ...
      makeNotifications(time = new Date(), text, id) {
        console.log(time); // console.log("makeNotifications")
      ...
      requestNotifications() {
        this.localNotifications.hasPermission().then(isPermitted => {
          ...
          if (!isPermitted) this.localNotifications.requestPermission().then(isGranted => {
    ...
    LocalNotificationsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_local_notifications_ngx__WEBPACK_IMPORTED_MODULE_2__["LocalNotifications"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"]])], LocalNotificationsService);
    /***/
  }
}]);
//# sourceMappingURL=default~fast-fast-module~timer-timer-module-es5.js.map